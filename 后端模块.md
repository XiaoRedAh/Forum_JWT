...
根据数据表，构造评论的实体类com/xiaoRed/entity/dto/TopicComment.java
```java
@Data
@AllArgsConstructor
@NoArgsConstructor
...
com/xiaoRed/entity/vo/response/CommentVo.java
```java
/**
 * 展示评论
 */
...
不仅仅是提醒帖子广场中谁赞了你，收藏你的文章，其他板块也需要收到提醒，甚至可以接收到管理员发来的全局通知
